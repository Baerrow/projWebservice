...
use GenreBundle\Form\GenreType;
...
class GenreController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('GenreBundle:Genre')->findAll();
     ...
     *
     * @Route("/", name="genres_create")
     * @Method("POST")
     * @Template("GenreBundle:Genre:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('GenreBundle:Genre')->find($id);
     ...
     *
     * @Route("/{id}/edit", name="genres_edit")
     * @Method("GET")
     * @Template()
     */
    ...
    */
     ...
     *
     * @Route("/{id}", name="genres_update")
     * @Method("PUT")
     * @Template("GenreBundle:Genre:edit.html.twig")
     */
